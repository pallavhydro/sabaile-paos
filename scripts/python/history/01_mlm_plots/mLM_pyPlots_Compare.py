...
colors2  = ['lightseagreen',         'lightseagreen',        'lightseagreen',
...
#---------------
# Output 1
fname1 = "/Users/shresthp/pallav/01_work/Python/mLM_pyPlots/daily_waterBalance_lake1_NOopt.bal"
# Output 2
fname2 = "/Users/shresthp/pallav/01_work/Python/mLM_pyPlots/daily_waterBalance_lake1_opt_test1.bal"
...
for iPlot, iVar in enumerate(order1):
    ...
    plt.fill_between(date1, data1[:, iVar], color="lightcoral", label='wo Opti', alpha = 0.5)
    plt.fill_between(date2, data2[:, iVar], color="lightseagreen", label='w Opti', alpha = 0.5)
