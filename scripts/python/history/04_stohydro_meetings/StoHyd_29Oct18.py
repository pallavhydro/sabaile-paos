...
# yaxis labels 
ylabs   = ['precipitation, mcm',    'evaporation, mcm',         'percolation, mcm',          #  0,  1,  2
           'baseflow, mcm',         'environmental flow, mcm',  'hydropwer, mcm',            #  3,  4,  5  
           'watersupply, mcm',      'irrigation, mcm',          'spill, mcm',                #  6,  7,  8
           'inflow, mcm',           'outflow, mcm',             'lake GW, mcm',              #  9, 10, 11
...
# READ FILE
#---------------
fname = "/Users/shresthp/pallav/01_work/Python/StoHyd Meetings/daily_waterBalance_lake1.bal"
