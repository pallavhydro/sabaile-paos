...
for (i in 1:nLakes) {
  ...
  for (j in 1:nLags) {
    ...
    colnames(data_mon) <- c("data_precip_PET_ups_mon","data_hws_obs_mon")
...
# Output
pdf("regulation_hysteresis_connected_scatterplot_withLags.pdf", width = 5*nColPlot, height = 5*nRowPlot) # each subplot is 5x5 inches
