######################################################################################################### 
##
## ========================== Lake Annual Climatology call script
##
#########################################################################################################


# Source taylor-made functions
source("plot_across_domains_and_suites.R")
...
plot_across_domains_and_suites(path, path_suffix, file_suffix, title_text, caption_text )
