...
# optimal value time series with others as NA
...
# plot
plot(data_pro$kge_t, ylim = c(0, 1), xlab = "iterations random forest (with random ordering of years)", ylab = "KGE", col = "blue")
...
legend("topright", inset = c(0, 0), 
       ...
       ncol = 2)
# legend(600, 1, legend = c("training", "validation"), pch = c(21, 21), col = c("blue", "red"),
#        ncol = 2)
